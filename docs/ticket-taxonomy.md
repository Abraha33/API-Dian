...
2. Full solo-dev guide: [GITHUB_PROJECTS.md](./GITHUB_PROJECTS.md) (columns, workflows, views).
...
5. Columns example: **Icebox → Backlog → Ready → In progress → In review → Done** (adjust to your process).
