...
**Corte de evidencia pública:** 2026-08-18  
...
La página consultada enumera 98 proveedores tecnológicos autorizados. Entre ellos:
...
`EstadoDocumento` demuestra capacidad de consulta, pero la documentación pública localizada no establece que un resultado “no encontrado” después de timeout tenga consistencia/semántica suficiente para autorizar reemisión. Debe probarse y obtenerse por escrito.
...
- precios: https://www.dataico.com/planes-y-precios
...
Fuente DIAN confirma habilitación. Se localizaron endpoints/producto en dominios Facture y un visor público con descarga XML/PDF, pero no documentación pública suficiente de la API V1 para compararlo responsablemente con HKA/Dataico.

Decisión: reserva, no invertir tiempo de integración todavía.

## 6. Orden de prueba

### Candidato A — The Factory HKA

Primero porque la evidencia pública actual es más fuerte exactamente en nuestro riesgo crítico: consulta de estado y artefactos para FE/DEE.
...
Para cada candidato pedir respuesta escrita a:
